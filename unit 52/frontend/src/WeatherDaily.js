...
/** Component for displaying a single day's weather forecast */
      ...
      {!isOpen && (
        <CardBody className="closedCard">
          ...
          <Row>
            <Col xs={3}>
              <img
                src={`${ICON_URL}${daily.weather.icon}.png`}
            ...
            <Col xs={5} md={3}>
              <Button
                className="dropdown-toggle WeatherToggle"
                onClick={toggle}
              >
                See More
              </Button>
      ...
      <Collapse isOpen={isOpen}>
        <CardBody className="openCard">
          ...
          <img
            ...
            className="openImg"
          />
          <CardText>{daily.weather.description}</CardText>
          <CardText>Precipitation chance: {daily.pop}%</CardText>
          <CardText>
          ...
          <CardText>
            Wind: {daily.wind_spd}
            {units === "i" ? "mph " : "km/h "}
            {daily.wind_cdir}, gust speed {daily.wind_gust_spd}
            {units === "i" ? "mph " : "km/h "}
          </CardText>
