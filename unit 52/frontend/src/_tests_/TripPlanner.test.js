    ...
    data: [
      {
        ...
        fuel: { has_diesel: false, has_propane: false, has_gas: true },
      },
      {
        id: "test2",
        kind: "ramp",
        ...
        fuel: { has_diesel: false, has_propane: false, has_gas: false },
      },
    ],
  },
};
...
test("renders", async () => {
  ...
  WeTripApi.getUserTrips.mockResolvedValue(tripsRes);
  WeTripApi.getRecentTrips.mockResolvedValue(tripsRes);
  render(
    <BrowserRouter>
      <TripPlanner />
    </BrowserRouter>
